...
var list = ["jquery/jquery", "jquery/jquery-ui", "jquery/jquery.mousewheel", "vis/vis", "uikit/v3/uikit", "pixi/pixi", "ani/TweenLite", "socket.io", "handlebars"
// "require"
];
function getLibs(min) {
